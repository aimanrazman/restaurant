                            ...
                            <form action="{{url('/orderconfirm')}}" method="post">
                                ...
                                @csrf
                                    ...
                                    @foreach($data2 as $data2)
                                        <tr style="position: relative; top: -110px; right: -390px;">
                                            <td>
                                                <label class="badge badge-danger"><a href="{{url('/remove', $data2->id)}}" style="color: #ffffff">Remove</a></label>
                                            </td>
                                        </tr>
                                    @endforeach
                                ...
                                <div align="center" style="padding: 10px; display: none;" id="appear">
                                    ...
                                    <div style="padding: 10px;">
                                        ...
                                        <input id="cancel" type="submit" class="btn btn-danger" value="Cancel">
                                    </div>
                                </div>
                            </form>
                    </div>
